        ...
        <ToastProvider>
          <div className="flex h-screen overflow-hidden">
            ...
            <div className="relative flex flex-1 h-full lg:flex-row">
              ...
              <main className="flex-1 flex flex-col min-h-0 min-w-0 mb-24 lg:mb-0">
                <Header />
                <div className="flex-1 overflow-y-auto min-w-0">{children}</div>
              </main>

              {/* 우측/하단 플레이어 영역 */}
              <aside className="absolute bottom-0 lg:static min-w-0 w-full h-24 border-t-2 border-primary lg:w-95 lg:h-full lg:border-t-0 lg:border-l-2">
                <RightPanel />
              </aside>
            </div>
          </div>
