  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <h3 className="text-xl font-black text-accent-pink truncate">좋아요 표시한 곡</h3>
      ...
      {/* Action */}
      <div className="px-4 opacity-0 group-hover:opacity-100 transition-opacity -translate-x-2 group-hover:translate-x-0 duration-200">
